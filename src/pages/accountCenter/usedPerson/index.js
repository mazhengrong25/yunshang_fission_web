...
import { Input, Button, Table, Pagination, Modal, Select, DatePicker, message, Popover } from 'antd';
...
export default class index extends Component {
    ...
    deleteBatch() {
        ...
        if (this.state.selectedRowKeys.length < 1) {
            ...
            // }
            this.$axios.post('/api/passenger/dels/' + this.state.selectedRowKeys).then((res) => {
                if (res.errorcode === 10000) {
    ...
    submitPerson() {
        ...
        if (this.state.personClass) {
            ...
            this.$axios.post('/api/passenger/edit/' + this.state.tableItemID, data).then((res) => {
                if (res.errorcode === 10000) {
                    message.success(res.msg)
                    this.showModal = false;
                    this.getDataList();
    ...
    async submitGroup() {
        ...
        if (this.state.groupClass) {
            ...
            // 编辑
            this.$axios.post('/api/passenger/groupEdit/' + this.state.activeGroupId, data).then(res => {
                console.log('编辑', res)
                if (res.errorcode === 10000) {
                    message.success(res.msg)
                    this.setState({
    ...
    removeRroup() {
        ...
        this.$axios.post('/api/passenger/groupDel/' + this.state.activeGroupId).then(res => {
            console.log(res)
            if (res.errorcode === 10000) {
                message.success(res.msg)
                this.setState({
            ...
            <div className="usedPerson">
                <div className="usedPerson_content_div">
                    ...
                    <div className="usedPerson_content">
                        <div className="usedPerson_div_menu">
                            ...
                            <div className="add_group"> <Button onClick={() => this.addGroup()}>+添加分组</Button></div>
                            {this.state.groupList.map((item, index) => (
                                <div
                                    className={this.state.activeGroupId === item.id ? "group_list group_active" : "group_list"}
                                    key={item.id}
                                    ...
                                    <Popover
                                        ...
                                        content={() => (
                                            ...
                                            <div className="divide_div">
                                                <div className="edit_modal" onClick={() => this.editGroup()}>编辑分组</div>
                                                <div className="edit_modal" onClick={() => this.deleteRroup()}>删除分组</div>
                                            </div>
                                        )}
                                    >
                        ...
                        <div className="usedPerson_div_right">
                            <div className="content_nav">
                                <div className="content_action">
                                    ...
                                    <Button type="primary" onClick={() => this.addPerson()}>新增人员</Button>
                                </div>
                            </div>
                                    ...
                                    locale={{
                                        emptyText: (
                                            <div className="table_emptyText">
                                                <p>当前分组暂无人员，请去添加</p>
                                                <Button type="link" onClick={() => this.addPerson()}>+新增人员</Button>
                                            </div>
                                        )
                                    }}
                                >
                                        ...
                                        render={(item, record) => (
                                            ...
                                            <div className="table_action">
                                                <div className="edit_btn"
                                                    onClick={() => this.eidtPerson(record)}
                                                ><img src={EditBtn} alt="编辑" /></div>
                    ...
                    <div className="add_modal">
                        ...
                        {this.state.divItem.map((item, index) => {
                            ...
                            <>
                                ...
                                <div className="modal_title">证件信息{index}</div>
                                <div key={index} className="modal_div">
                                    ...
                                    <div className="div_item">
                                        ...
                                        <div className="item_input">
                                            <Input
                                                ...
                                                allowClear
                                                // value={item.cert_no}
                                                onChange={this.inputBind.bind(this, "cert_no")}
                                            />
                                        </div>
                                    </div>
                                    <div className="div_item">
                                    ...
                                    <span onClick={() => this.delCert(index)}><img src={modalColse} alt="关闭"/></span>
                                    <div className="div_item">
                        ...
                        <div className="add_button" onClick={this.addCert}>+添加证件</div>
                    </div>
                </Modal>
                {/* 新增/编辑分组 */}
                <Modal
                    ...
                    footer={[
                        <Button type="primary" onClick={() => this.submitGroup()}>{this.state.groupClass ? '确定' : '修改'}</Button>,
                    ]}
                >
                ...
                >
                    <div className="delete_group">
                        <div className="middle_warn"><img src={BlueWarn} alt="警告图标" /></div>
                        <p>是否确定删除分组？</p>
