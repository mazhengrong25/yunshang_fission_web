                ...
                <div className="content_div">
                    ...
                    <div className="top_content">
                        <div className="item_avatar">
                            <div className="default_img"><img src={personIcon} alt="default" /></div>
                            <div className="default_title" onClick={() => this.uploadAvatar()}>上传头像</div>
                        </div>
                    ...
                    <div className="wallt_quota">
                        ...
                        <div className="quota_item">
                            <div className="quota_number">
                                ...
                                {/* 993.8 四舍五入 => 向下取整  */}
                                <p>({Math.floor(Number(this.state.walletInfo.msg_money) / Number(this.state.walletInfo.msg_price))}条)</p>
                            </div>
                    ...
                    <div className="account_item">
                        <div className="div_space">
                            <div className="item_content">
                                ...
                                <div className="content_input">{this.state.personInfo.department_name}</div>
                            </div>
                            <div className="item_content">
                        ...
                        <div className="div_space">
                            <div className="item_content">
                                ...
                                <div className="content_input">子账号</div>
                            </div>
                            <div className="item_content">
                                <div className="content_title">账号情况</div>
                                <div className="content_input">正常</div>
                            </div>
                            <div className="item_content">
                                <div className="content_title">登陆IP</div>
                                <div className="content_input">192.168.0.126</div>
                            </div>
                        </div>
                    </div>
                </div>
