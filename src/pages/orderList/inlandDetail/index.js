...
import { Table, Divider, Button, Breadcrumb, Modal, Radio, Input, Statistic, Spin } from "antd"
                        ...
                        <div className="content_status">
                            <div className="order_space">
                                ...
                                >
                                    {this.state.detailData.status === 1 ? "待支付"
                                        : this.state.detailData.status === 2 ? "待出票"
                            ...
                            <div className="order_space">
                                ...
                                {this.state.detailData.status === 1 ?
                                    ...
                                    (
                                        (this.state.detailData.status === 2 || this.state.detailData.status === 3 || this.state.detailData.status === 5) ?
                                            (<div className="order_not_pay">
                                                ...
                                                <div className="order_div">
                                                    ...
                                                    <div className="input_number_crease">
                                                        {this.state.detailData.pay_type === 1 ? "预存款" :
                                                            this.state.detailData.pay_type === 2 ? "授信支付" :
                                                                this.state.detailData.pay_type === 3 ? "易宝" :
                                                                    this.state.detailData.pay_type === 4 ? "支付宝" : ""}
                                                    </div>
                                                </div>
                                            </div>) : ""
                        ...
                        <div className="content_item">
                            ...
                            <div className="price_div">
                                ...
                                >
                                    ...
                                    />
                                    <Column title="奖励" dataIndex="reward_price"
                                        render={(text) => (
                                            <>&yen;{text}</>
                                        )
                                        }
                                ...
                                {this.state.detailData.status === 1 ?
                                    ...
                                    this.state.detailData.status === 5 || this.state.detailData.status === 2 ?
                                        (
                                            <div className="price_button">
