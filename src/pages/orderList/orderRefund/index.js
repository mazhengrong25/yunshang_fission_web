 ...
 * @LastEditTime: 2021-04-14 19:45:16
        ...
        <Spin spinning={this.state.loadStatus}>
          <div className="refund_content">
              ...
              <div className="refund_message">
                <div className="choice_item">
                  ...
                  <div className="choice_content">
                    <Radio.Group defaultValue={1} onChange={this.getRadioValue}>
            ...
            <div className="refund_content_item">
              ...
              <Checkbox.Group onChange={this.getCheckValue}>
                      ...
                      <div className="passenger_item">
                        <div className="passenger_checkbox">
                          <Checkbox value={item.id}>
                            <span className="passenger_number">乘机人{index + 1}</span>
                          </Checkbox>
                        </div>
                    ...
                    <div className="message_div">
                      <div className="item_space">
                        <div className="message_item">
                          ...
                          <div className="passenger_identity">
                            {item.ticket_department}
                          </div>
                        </div>
                ...
                >
                  ...
                  <Column
                    ...
                    render={(text, render) => (
                      <>
                        &yen;
                        {((this.state.refundRate / 100) * render.total_price).toFixed(
                          2
                        ) || 0}
                      </>
                    )}
